  ...
  // },
  {
    ...
    buildPayload: (payload) => ({
      formData: {
        ...
        isHistoricOrArtisticBuilding: payload.isHistoricOrArtisticBuilding,
        fillUnderwritingQuestionnaire: payload.fillUnderwritingQuestionnaire,
        buildingClass: payload.buildingClass,
        search: payload.search,
        fabbricate: payload.fabbricate,
        buildingInsuredAmount: payload.buildingInsuredAmount,
        equipment: payload.equipment,
        equipmentInsuredAmount: payload.equipmentInsuredAmount,
        land: payload.land,
        landInsuredAmount: payload.landInsuredAmount,
      },
    }),
  },
];
